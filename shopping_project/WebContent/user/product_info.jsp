...
<body>
	...
	<script type="text/javascript">
			...
			function addProduct(pid) {
				...
				location.href = "${pageContext.request.contextPath}/cartServlet?method=addProduct&&pid="+pid+"&&num="+num;
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${p.shop_price }/份</strong>
						参 考 价：
						<del>￥6.00元/份</del>
					</div>
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a  href="javascript:addProduct(${p.pid})">
							 <input
